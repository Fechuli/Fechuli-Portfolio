...
const fragmentShaderSource = `
    ...
    void main() {
        ...
        // Apply noise-based organic distortion
        ...
        // Erosion effect - darken and add noise
        if (erosion > 0.0) {
            // Color corruption
